...
const credentials = JSON.parse(fs.readFileSync('./src/configs.json', 'utf-8'));
...
console.log('');
const options = ["Walmart Plus Cancel and Reund", "Walmart Plus Refund"]
